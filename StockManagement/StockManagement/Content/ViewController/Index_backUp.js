...
function showEditModal(clickedItemName) {
    ...
    try {
        $.ajax({
            ...
            success: function (result) {
                addDataToEditModal(null, result.Item, result.ItemCount, result.Cost, result.SaleCost, result.Profit, result.SendCost, result.SendCostProfit, result.PakagingCost, result.CustomerNames);
            },
            error: function (error) {
                console.log("error");
            }
